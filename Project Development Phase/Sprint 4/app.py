...
dotenv_path=Path('/app/sendgrid.env')
...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=6667d8e9-9d4d-4ccb-ba32-21da3bb5aafc.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30376;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=dpg76241;PWD=toQpL4QIxS8KPPB2",'','')
...
def requested():
    ...
    while data != False:
        ...
        message = Mail(
            from_email='raajeshg@outlook.com',
            to_emails=data["EMAIL"],
            subject='Notification from Plasma Donor Application',
            html_content=msg)
        try:
            sg = SendGridAPIClient(os.environ.get(api))
